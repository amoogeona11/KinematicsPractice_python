...
L2 = 10
L4 = 400
def calcORGs1(theta1,l2,theta3,theta4,l5,d2,alpha3,alpha4,d5):
...
def calcORGs2(theta1,l2,theta3,theta4,l5,d2,alpha3,alpha4,d5):
    theta1 = dR.conv2Rad(theta1)
    theta3 = dR.conv2Rad(theta3)
    theta4 = dR.conv2Rad(theta4)
    alpha3 = dR.conv2Rad(alpha3)
    alpha4 = dR.conv2Rad(alpha4)
    T01 = np.dot(dR.D_q(0, 0, 2 * L1), dR.RotZ(theta1))
    T12 = dR.D_q(L1, -300, (L1-l2+300))
    T23 = np.dot(dR.D_q(L2, 0, 0), dR.RotX(-theta3))
    T34 = dR.RotZ(theta4)
    T45 = np.dot(dR.D_q(0, -L4, 0), dR.D_q(0, -l5, 0))
    M12 = dR.D_q(-L1, -300, (L1-d2+300))
    M23 = np.dot(dR.D_q(-L2, 0, 0), dR.RotX(alpha3))
    M34 = dR.RotZ(alpha4)
    M45 = np.dot(dR.D_q(0, -L4, 0), dR.D_q(0, -d5, 0))
...
def update(val):
    ...
    alpha4 = R4Angle.val
    d5 = R5Length.val
    if l2<800 and d2<800:
        org1, org2, org3, org4, org5, Rorg2, Rorg3, Rorg4, Rorg5 = calcORGs1(theta1, l2, theta3, theta4, l5, d2, alpha3, alpha4, d5)
    elif l2<800 and d2>=800:
        org1, org2, org3, org4, org5, Rorg2, Rorg3, Rorg4, Rorg5 = calcORGs1(theta1, l2, theta3, theta4, l5, d2, alpha3, alpha4, d5)
        org1, b, c, d, e, Rorg2, Rorg3, Rorg4, Rorg5 = calcORGs2(theta1, l2, theta3, theta4, l5, d2, alpha3, alpha4, d5)
    elif l2>=800 and d2<800:
        org1, org2, org3, org4, org5, Rorg2, Rorg3, Rorg4, Rorg5 = calcORGs1(theta1, l2, theta3, theta4, l5, d2, alpha3, alpha4, d5)
        org1, org2, org3, org4, org5, a, b, c, d = calcORGs2(theta1, l2, theta3, theta4, l5, d2, alpha3, alpha4, d5)
    elif l2>=800 and d2>=800:
        org1, org2, org3, org4, org5, Rorg2, Rorg3, Rorg4, Rorg5 = calcORGs2(theta1, l2, theta3, theta4, l5, d2, alpha3, alpha4, d5)
    ax.cla()
    drawObject(org1,org2,org3,org4,org5,Rorg2,Rorg3,Rorg4,Rorg5)

org1, org2, org3, org4, org5, Rorg2, Rorg3, Rorg4, Rorg5 = calcORGs1(th1Init,l2Init,th3Init,th4Init,l5Init,d2Init,ap3Init,ap4Init,d5Init)
...
L2Length = Slider(l2Length, r'$ l_L2 $', 200, 1400, valinit=l2Init)
...
R2Length = Slider(d2Length, r'$ l_R2 $', 200, 1400, valinit=d2Init)
