...
def RightcalcORGs(th1,l_2,th3,th4,l_5):
    ...
    org5 = np.array(T5(theta_1, L1, L2, L4, len2, theta_3, theta_4, len5))
    return org1, org2, org3, org4, org5
def get_ik_sol(Leftgoal,Rightgoal,Left_origin_state,Right_origin_state,iter):
    ...
    return theta1_tr, Ll2_tr, Ltheta3_tr, Ltheta4_tr, Ll5_tr, Rl2_tr, Rtheta3_tr, Rtheta4_tr, Rl5_tr
...
trace_th1, Ltrace_l2, Ltrace_th3, Ltrace_th4, Ltrace_l5, Rtrace_l2, Rtrace_th3, Rtrace_th4, Rtrace_l5 = get_ik_sol(Ldestination,Rdestination,Left_origin_state,Right_origin_state,50)
print(trace_th1)
print(Ltrace_l2)
print(Ltrace_th3)
print(Ltrace_th4)
